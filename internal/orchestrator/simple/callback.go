...
func (c *simpleCallbackHandler) HandleCallback(
	...
	return dto.PaymentResponse{
		...
		PaymentInfo: dto.PaymentInfoResponse{
			...
			DigitalRubleData:  req.PaymentInfo.DigitalRubleData,
		...
		TransactionDetails: dto.TransactionDetails{
			...
			MoneyMark:             adapterResult.MoneyMark,
			SmartContractID:       adapterResult.SmartContractID,
			SmartContractResult:   adapterResult.SmartContractResult,
			SmartContractReason:   adapterResult.SmartContractReason,
			PlatformMessageID:     adapterResult.PlatformMessageID,
			PlatformTransport:     adapterResult.PlatformTransport,
			PlatformSignatureType: adapterResult.PlatformSignatureType,
